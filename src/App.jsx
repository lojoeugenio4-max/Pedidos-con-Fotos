...
/* =========================
   📸 IMÁGENES POR IDNUM
   Si el artículo tiene idnum 23, su foto debe llamarse 23.jpg, 23.png, 23.webp, etc.
========================= */
...
const hiddenProductsFormattedBase = hiddenProductsUnique.map((name) => {
  const idnum = autoIdnum;
  autoIdnum += 1;
